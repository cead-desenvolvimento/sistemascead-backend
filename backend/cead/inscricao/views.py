...
class VagasEditalFaseInscricaoView(GenericAPIView):
    ...
    # Colocar o ID da vaga na sessão
...
class PessoaVagaCampoView(APIView):
    ...
    def post(self, request):
        ...
        ## Informar ao Academico que sempre necessaria a insercao de um item com zero pontos
        ...
        # Como e' obrigatorio, adiciona o que o candidato marcou, salvo se for zero
        # Salvo se a pontuacao for NULL ou 0, porque esse campo geralmente e' pontuacao por numero de certificados
