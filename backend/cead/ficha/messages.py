...
# ------------------------------
ERRO_CREATE_DADOS = "Erro na criação do dados pessoais"
ERRO_ED_PESSOA_VAGA_VALIDACAO_GEROU_FICHA_JA_EXISTE = "A ficha já foi gerada"
ERRO_ED_PESSOA_VAGA_VALIDACAO_GEROU_FICHA_NAO_EXISTE = (
    "Dados de controle da geração da ficha não encontrados"
)
...
# ------------------------------
# ERROS - CURSO E FUNÇÃO
# ------------------------------
ERRO_GET_AC_CURSO = "Não há curso associado ao edital"
ERRO_GET_AC_CURSO_OFERTA = "Oferta de curso inválida"
ERRO_GET_FI_FUNCAO_BOLSISTA = "Função de bolsista inválida"
